...
function buildCFG(astGraph: Graph): CFGraphReturn {
    ...
    function checkUnknownCalledFunctions(functionName: string, functionContext: number, calledFunctionId: number): void {
        ...
        //
            ...
            case "LabeledStatement": {
                ...
                if ((node.type === "FunctionDeclaration" || node.type === "FunctionExpression")) {
                    ...
                    if (node.functionName) checkUnknownCalledFunctions(node.functionName, node.functionContext, _start.functionNodeId)
