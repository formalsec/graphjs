  ...
  function compare(orig, compareTo, options, cb) {
    ...
    if (typeof options === 'object') {
      ...
      if (options.file) {
        ...
        var highlightColorOption = options.highlightColor ? ' -highlight-color ' + options.highlightColor + ' ' : ' ';
        var highlightStyleOption = options.highlightStyle ? ' -highlight-style ' + options.highlightStyle + ' ' : ' ';
