...
module.exports = { symb_array_length, symb_prefix, symb_num_prefix, symb_str_prefix, symb_bool_prefix, concrete_prefix, obj_prefix, obj_prop_prefix, array_prefix, symb_test }